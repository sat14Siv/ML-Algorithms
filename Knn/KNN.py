...
def get_predictions(sample, train_data, k):   # Returns the predicted target/ class of an instance
    ...
    prediction = nearestNeighbors[4].value_counts().index[0] # Most ocurring class in the neighbors is returned
    return prediction
...
if __name__ == '__main__':
    ...
    # Now, use the test data. In mmy case, there is no test data
